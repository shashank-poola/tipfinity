    ...
    <footer className="bg-black text-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex justify-center gap-6 md:gap-8 mb-8">
          ...
          <a href="https://reddit.com" target="_blank" rel="noopener noreferrer" className="text-foreground hover:text-primary transition-colors">
            <svg className="w-6 h-6 md:w-8 md:h-8" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Footer Links */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 mb-12 text-sm md:text-base">
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Swap</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Wallet</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors">Need Changes</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="max-w-md mx-auto">
          <h3 className="font-semibold mb-3 text-center">Get latest updates</h3>
          <div className="flex gap-2">
            <input
              type="email"
              placeholder="Email"
              className="flex-1 px-4 py-2 bg-muted border border-input rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary"
            />
          ...
          <p className="text-xs text-muted-foreground text-center mt-3">
            By subscribing, you agree to receive tipfinity updates and marketing emails. You can unsubscribe anytime.
          </p>
        </div>
